...
const Footer = () => {
	return (
		<footer className="footer footer-center md:px-48 p-10 bg-slate-800 text-base-200 grid grid-cols-1 md:grid-cols-3">
			<div>
			...
			<div>
				...
				<p className="text-center mx-auto">Copyright © 2030 - All right reserved</p>
